...
#define __PYX_HAVE__optimizedFilter
#define __PYX_HAVE_API__optimizedFilter
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'optimizedFilter' */
...
static __Pyx_memviewslice __pyx_f_15optimizedFilter_quantize_gray(__Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "optimizedFilter"
extern int __pyx_module_is_main_optimizedFilter;
int __pyx_module_is_main_optimizedFilter = 0;

/* Implementation of 'optimizedFilter' */
...
static const char __pyx_k_frame_gray[] = "frame_gray";
...
static PyObject *__pyx_n_s_frame_gray;
...
static PyObject *__pyx_pf_15optimizedFilter_quantize_gray(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_frame_gray, int __pyx_v_n_levels); /* proto */
...
static PyObject *__pyx_pw_15optimizedFilter_1quantize_gray(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_15optimizedFilter_quantize_gray(__Pyx_memviewslice __pyx_v_frame_gray, int __pyx_v_n_levels, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_w;
  int __pyx_v_h;
  ...
  __Pyx_RefNannySetupContext("quantize_gray", 0);

  /* "optimizedFilter.pyx":8
 * cpdef unsigned char[:, :] quantize_gray(unsigned char [:, :] frame_gray, int n_levels):
 *     cdef int x, y, w, h
 *     h = frame_gray.shape[0]             # <<<<<<<<<<<<<<
 ...
 *     for y in range(0, h):
 */
  __pyx_v_h = (__pyx_v_frame_gray.shape[0]);

  /* "optimizedFilter.pyx":9
 *     cdef int x, y, w, h
 *     h = frame_gray.shape[0]
 *     w = frame_gray.shape[1]             # <<<<<<<<<<<<<<
 *     for y in range(0, h):
 *         for x in range(0, w):
 */
  __pyx_v_w = (__pyx_v_frame_gray.shape[1]);

  /* "optimizedFilter.pyx":10
 *     h = frame_gray.shape[0]
 *     w = frame_gray.shape[1]
 *     for y in range(0, h):             # <<<<<<<<<<<<<<
 *         for x in range(0, w):
 ...
 */
      ...
      __pyx_t_9 = -1;
      if (__pyx_t_7 < 0) {
        __pyx_t_7 += __pyx_v_frame_gray.shape[0];
        if (unlikely(__pyx_t_7 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_7 >= __pyx_v_frame_gray.shape[0])) __pyx_t_9 = 0;
      if (__pyx_t_8 < 0) {
        __pyx_t_8 += __pyx_v_frame_gray.shape[1];
        if (unlikely(__pyx_t_8 < 0)) __pyx_t_9 = 1;
      } else if (unlikely(__pyx_t_8 >= __pyx_v_frame_gray.shape[1])) __pyx_t_9 = 1;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 12, __pyx_L1_error)
      }
      __pyx_t_10 = PyFloat_FromDouble((((double)((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame_gray.data + __pyx_t_7 * __pyx_v_frame_gray.strides[0]) ) + __pyx_t_8 * __pyx_v_frame_gray.strides[1]) ))) * __pyx_v_n_levels)) / 255.0)); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 12, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_11 = __Pyx_PyObject_CallOneArg(__pyx_builtin_round, __pyx_t_10); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 12, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_10 = PyNumber_Multiply(__pyx_t_11, __pyx_int_255); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 12, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_t_11 = __Pyx_PyInt_From_int(__pyx_v_n_levels); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 12, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_12 = __Pyx_PyNumber_Divide(__pyx_t_10, __pyx_t_11); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 12, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_12);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_t_13 = __Pyx_PyInt_As_unsigned_char(__pyx_t_12); if (unlikely((__pyx_t_13 == (unsigned char)-1) && PyErr_Occurred())) __PYX_ERR(0, 12, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
      __pyx_t_14 = __pyx_v_y;
      __pyx_t_15 = __pyx_v_x;
      __pyx_t_9 = -1;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_v_frame_gray.shape[0];
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_14 >= __pyx_v_frame_gray.shape[0])) __pyx_t_9 = 0;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_frame_gray.shape[1];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_9 = 1;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_frame_gray.shape[1])) __pyx_t_9 = 1;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 12, __pyx_L1_error)
      }
      *((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_frame_gray.data + __pyx_t_14 * __pyx_v_frame_gray.strides[0]) ) + __pyx_t_15 * __pyx_v_frame_gray.strides[1]) )) = __pyx_t_13;
    }
  }

  /* "optimizedFilter.pyx":13
 *         for x in range(0, w):
 *             frame_gray[y, x] = round(frame_gray[y, x] * n_levels / 255) * 255 / n_levels
 *     return frame_gray             # <<<<<<<<<<<<<<
 * 
 */
  __PYX_INC_MEMVIEW(&__pyx_v_frame_gray, 0);
  __pyx_r = __pyx_v_frame_gray;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("optimizedFilter.quantize_gray", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_15optimizedFilter_1quantize_gray(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_15optimizedFilter_1quantize_gray(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_frame_gray = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_n_levels;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("quantize_gray (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_frame_gray,&__pyx_n_s_n_levels,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_frame_gray)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_levels)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("quantize_gray", 1, 2, 2, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "quantize_gray") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_frame_gray = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_frame_gray.memview)) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_n_levels = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_n_levels == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("quantize_gray", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("optimizedFilter.quantize_gray", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_15optimizedFilter_quantize_gray(__pyx_self, __pyx_v_frame_gray, __pyx_v_n_levels);
...
static PyObject *__pyx_pf_15optimizedFilter_quantize_gray(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_frame_gray, int __pyx_v_n_levels) {
  ...
  if (unlikely(!__pyx_v_frame_gray.memview)) { __Pyx_RaiseUnboundLocalError("frame_gray"); __PYX_ERR(0, 6, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_15optimizedFilter_quantize_gray(__pyx_v_frame_gray, __pyx_v_n_levels, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 6, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_frame_gray, 1);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "optimizedFilter.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "optimizedFilter._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"quantize_gray", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15optimizedFilter_1quantize_gray, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_optimizedFilter(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_optimizedFilter},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_frame_gray, __pyx_k_frame_gray, sizeof(__pyx_k_frame_gray), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initoptimizedFilter(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initoptimizedFilter(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_optimizedFilter(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_optimizedFilter(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_optimizedFilter(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'optimizedFilter' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_optimizedFilter(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("optimizedFilter", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_optimizedFilter) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "optimizedFilter")) {
      if (unlikely(PyDict_SetItemString(modules, "optimizedFilter", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "optimizedFilter.pyx":2
 * # cython: language_level=3
 * import cv2             # <<<<<<<<<<<<<<
 * import math
 * 
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_cv2, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_cv2, __pyx_t_1) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "optimizedFilter.pyx":3
 * # cython: language_level=3
 * import cv2
 * import math             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init optimizedFilter", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init optimizedFilter");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
